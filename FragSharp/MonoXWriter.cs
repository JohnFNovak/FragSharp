...
namespace FragSharp
{
    ...
    /// </summary>
    internal class MonoXWriter : CStyleWriter
    {
        public MonoXWriter(Dictionary<SyntaxTree, SemanticModel> models, Compilation compilation)
            : base(models, compilation)
        {
        }

        public MonoXWriter(MonoXWriter writer)
            : base(writer)
        {
        }
        ...
        override protected void CompileInvocationExpression(InvocationExpressionSyntax expression)
        {
            ...
            if (symbol != null)
            {
                ...
                else
                {
                    ...
                    var writer = new MonoXWriter(this);
