...
// NOTE: it seems like a lot of this could bemoved into CStyleWriter instead of being duplicated here and in HlslWriter
...
namespace FragSharp
{
    ...
    /// </summary>
    internal class MonoGLWriter : CStyleWriter
    {
        public MonoGLWriter(Dictionary<SyntaxTree, SemanticModel> models, Compilation compilation)
            : base(models, compilation)
        {
        }

        public MonoGLWriter(MonoGLWriter writer)
            : base(writer)
        {
        }
        ...
        override protected void CompileInvocationExpression(InvocationExpressionSyntax expression)
        {
            ...
            if (symbol != null)
            {
                ...
                if (special != null)
                {
                    ...
                    switch (name)
                    {
                        case Special.rgba_hex:
                            ...
                            //Write("vec4({0}, {1})", HexToVec4(hex_literal.ToString()), float_literal.ToString());
                        ...
                        case Special.rgb_hex:
                            ...
                            Write("vec4({0}, 1.0)", HexToVec4(_hex_literal.ToString()));
                            break;
                    }
                }
                ...
                else
                {
                    ...
                    var writer = new MonoGLWriter(this);
