...
namespace FragSharpFramework
{
    ...
    public class FragSharpStd
    {
        ...
        public static vec2 Float(vec2 v) { return floor(255 * v + vec(.5f, .5f)); }
        public static vec3 Float(vec3 v) { return floor(255 * v + vec(.5f, .5f, .5f)); }
        public static vec4 Float(vec4 v) { return floor(255 * v + vec(.5f, .5f, .5f, .5f)); }
